...
int main(void)
{
    ...
    while(1)
    {
        ...
        case STATE_INIT:
            ...
            Delay_Ms(100); // Additional delay for radios to propertly powers on
        ...
        case STATE_CONN_START:
            ...
            // If pairing with a drone is successfull or not change the state
